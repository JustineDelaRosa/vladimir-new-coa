...
//                    ->orWhere('account_titles.account_title_name', 'LIKE', "%{$search}%");
        ...
        $fixedAsset = $fixedAsset->select(
            ...
            'departments.department_name as charged_department',
            ...
            'care_of',
            DB::raw("COALESCE(companies.company_code, '-') as company_code"),
            DB::raw("COALESCE(companies.company_name, '-') as company_name"),
            DB::raw("COALESCE(business_units.business_unit_code, '-') as business_unit_code"),
            DB::raw("COALESCE(business_units.business_unit_name, '-') as business_unit_name"),
            DB::raw("COALESCE(departments.department_code, '-') as department_code"),
            DB::raw("COALESCE(departments.department_name, '-') as department_name"),
            DB::raw("COALESCE(units.unit_code, '-') as unit_code"),
            DB::raw("COALESCE(units.unit_name, '-') as unit_name"),
            DB::raw("COALESCE(sub_units.sub_unit_code, '-') as sub_unit_code"),
            DB::raw("COALESCE(sub_units.sub_unit_name, '-') as sub_unit_name"),
            DB::raw("COALESCE(locations.location_code, '-') as location_code"),
