...
class FixedAssetController extends Controller
{
    ...
    public function store(FixedAssetRequest $request)
    {
        ...
        $fixedAsset = $this->fixedAssetRepository->storeFixedAsset($request->validated(), $vladimirTagNumber, $departmentQuery);
...
//    }
    ...
    public function search(Request $request)
    {
        ...
        $fixedAsset = $this->fixedAssetRepository->searchFixedAsset($search, $limit);
