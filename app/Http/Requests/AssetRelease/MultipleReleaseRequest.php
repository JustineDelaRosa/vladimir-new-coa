...
//            'signature' => ['required'],
            ...
            'assignment_memo_img' => ['required-if:accountability,Personal Issued', new Base64ImageValidation()],
            'authorization_memo_img' => ['required-if:accountability,Personal Issued', new Base64ImageValidation()],
