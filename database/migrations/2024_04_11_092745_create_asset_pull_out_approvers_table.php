...
class CreateAssetPullOutApproversTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('asset_pull_out_approvers', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('asset_pull_out_approvers');
    }
}
